...
def create_db():
    ...
    con.commit()
    cur.execute("CREATE TABLE IF NOT EXISTS result(rid INTEGER PRIMARY KEY AUTOINCREMENT,roll integer,name text,course text,marks_ob text,full_marks text,per text)")
    con.commit()
create_db()